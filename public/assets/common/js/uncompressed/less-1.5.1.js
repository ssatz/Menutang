        ...
        return parser = {
            ...
            parsers: {
                ...
                element: function () {
                    ...
                    if (e) {
                        return new (tree.Element)(c, e, i, env.currentFileInfo);
                    }
                },
    ...
    (function (tree) {
        ...
        tree.joinSelectorVisitor.prototype = {
            ...
            visitRuleset: function (rulesetNode, visitArgs) {
                ...
                if (!rulesetNode.root) {
                    rulesetNode.selectors = rulesetNode.selectors.filter(function (selector) {
            ...
            visitRuleset: function (rulesetNode, visitArgs) {
                ...
                for (extendIndex = 0; extendIndex < allExtends.length; extendIndex++) {
                    for (pathIndex = 0; pathIndex < rulesetNode.paths.length; pathIndex++) {
                        ...
                        if (rulesetNode.extendOnEveryPath || selectorPath[selectorPath.length - 1].extendList.length) {
                            continue;
                        }
