    ...
    var L = function (h) {
        var j = function (e) {
            ...
            function ya(a) {
                ...
                var b = '<select class="form-control input-sm inline-block" size="1" style="width:100px;" ' + ('name="' + a.sTableId + '_length"') + ">", c, d, i = a.aLengthMenu;
