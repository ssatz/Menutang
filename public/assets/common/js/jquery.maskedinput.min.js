    ...
    e.fn.extend({
        caret: function (e, t) {
            ...
            return this.trigger("unmask").each(function () {
                    ...
                    if (t.ctrlKey || t.altKey || t.metaKey || n < 32) {
                        ...
                        if (o < h) {
                            ...
                            if (f[o].test(a)) {
                                ...
                                l = v(o);
                                if (s) {
                                    setTimeout(e.proxy(e.fn.caret, u, l), 0)
                                } else {
                                    u.caret(l)
                                }
                                if (r.completed && l >= h) {
                ...
                if (!u.attr("readonly"))u.one("unmask", function () {
                    ...
                    setTimeout(function () {
                        var e = x(true);
                        u.caret(e);
                        if (r.completed && e == u.val().length)r.completed.call(u)
                    }, 0)
                });
                x()
            })
