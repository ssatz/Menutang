...
(function (e, t, n, r) {
    ...
    var o = i ? "touchstart" : "mousedown", u = i ? "touchmove" : "mousemove", a = i ? "touchend" : "mouseup";
    ...
    l.prototype = {
        init: function () {
            ...
            if (i) {
                n.el[0].addEventListener(o, r, false);
                t.addEventListener(u, s, false);
                t.addEventListener(a, f, false);
                t.addEventListener(eCancel, f, false)
            } else {
                n.el.on(o, r);
                n.w.on(u, s);
                n.w.on(a, f)
            ...
            if (!c.dirAx || v || p) {
                ...
                if (!this.dragRootEl.find(l.itemNodeName).length) {
                    this.dragRootEl.append('<div class="' + l.emptyClass + '"/>')
                }
                if (v) {
                    this.dragRootEl = d;
