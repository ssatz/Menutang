...
!function (e) {
        ...
        constructor: t, validators: {
            notnull: function (e) {
                ...
                if ("undefined" !== typeof r.options.remoteDatatype) {
                    o = {dataType: r.options.remoteDatatype}
                }
                var u = function (t, n) {
                    ...
                    r.updtConstraint({name: "remote", valid: t}, n);
                ...
                e.ajax(e.extend({}, {
                    url: n, data: s, type: r.options.remoteMethod || "GET", success: function (e) {
                        e = a(e);
        ...
        constructor: n, init: function (t, n) {
            ...
            for (var n in e) {
                ...
                if ("function" === typeof this.Validator.validators[n]) {
                    this.constraints[n] = {name: n, requirements: e[n], valid: null};
                    if (n === "required") {
            ...
            for (var n in e) {
                this.updtConstraint({name: n, requirements: e[n], valid: null}, t)
            }
    ...
    r.prototype = {
        constructor: r, initMultiple: function (t, n) {
            this.element = t;
            this.$element = e(t);
    ...
    i.prototype = {
        constructor: i, init: function (t, n, r) {
            this.type = r;
            this.items = [];
            this.$element = e(t);
            this.options = n;
            ...
            for (var n = 0; n < this.items.length; n++) {
                if ("undefined" !== typeof this.items[n] && false === this.items[n].validate()) {
                    t = false;
