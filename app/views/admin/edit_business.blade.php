                ...
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" name="business_unique_id"
                                       id="inputbusinessid"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control width60  input-sm" id="inputbusinessName"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" id="inputbudget"
                                       value="{{$business->budget}}" name="budget"
                                       placeholder="Budget">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputminideliveryAmt" class="col-lg-2 control-label">Minimum Delivery
                                Amount</label>

                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" id="inputminideliveryAmt"
                                       name="minimum_delivery_amt"
                                       placeholder="Minimun Delivery Amount"
                                       value="{{$business->minimum_delivery_amt}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputminiraildelAmt" class="col-lg-2 control-label">Minimum Rail Delivery
                                Amount</label>

                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" id="inputminiraildelAmt"
                                       name="minimum_rail_deli_amt"
                                       placeholder="Minimun Rail Delivery Amount"
                                       value="{{$business->minimum_rail_deli_amt}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" id="inputminipckAmt"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_outdoor_catering" type="radio"
                                           value="1" @if($business->is_outdoor_catering==1) checked
                                            @endif>
                                ...
                                <label class="label-radio inline">
                                    <input name="is_outdoor_catering" type="radio"
                                           value="0" @if($business->is_outdoor_catering==0) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group fa-comment @if($business->is_outdoor_catering==0) displayNone @endif">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control width60" id="txtoutdoorComments"
                                          name="outdoor_catering_comments"
                                          rows="3">{{$business->outdoor_catering_comments}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_party_hall" type="radio" value="1" @if($business->is_party_hall==1)
                                           checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_party_hall" type="radio" value="0" @if($business->is_party_hall==0)
                                           checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group  fa-comment @if($business->is_party_hall==0)  displayNone @endif">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control width60" id="txtpartyhallcomments"
                                          name="party_hall_comments"
                                          rows="3">{{$business->party_hall_comments}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_buffet" type="radio" value="1"
                                           @if($business->is_buffet==1)checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_buffet" type="radio" value="0"
                                           @if($business->is_buffet==0)checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_midnight_buffet" type="radio"
                                           value="1" @if($business->is_midnight_buffet==1) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_midnight_buffet" type="radio"
                                           value="0" @if($business->is_midnight_buffet==0) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_door_delivery" type="radio"
                                           value="1" @if($business->is_door_delivery==1) checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_door_delivery" type="radio"
                                           value="0" @if($business->is_door_delivery==0) checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_rail_delivery" type="radio"
                                           value="1" @if($business->is_rail_delivery==1) checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_rail_delivery" type="radio"
                                           value="0" @if($business->is_rail_delivery==0) checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_pickup_available" type="radio"
                                           value="1" @if($business->is_pickup_available==1) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_pickup_available" type="radio"
                                           value="0" @if($business->is_pickup_available==0) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_wifi_available" type="radio"
                                           value="1" @if($business->is_wifi_available==1) checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_wifi_available" type="radio"
                                           value="0" @if($business->is_wifi_available==0) checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_children_play_area" type="radio"
                                           value="1" @if($business->is_children_play_area==1) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_children_play_area" type="radio"
                                           value="0" @if($business->is_children_play_area==0) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_garden_restaurant" type="radio"
                                           value="1" @if($business->is_garden_restaurant==1) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_garden_restaurant" type="radio"
                                           value="0" @if($business->is_garden_restaurant==0) checked
                                            @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_roof_top" type="radio" value="1" @if($business->is_roof_top==1)
                                           checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_roof_top" type="radio" value="0"
                                           @if($business->is_roof_top==0)checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_valet_parking" type="radio"
                                           value="1" @if($business->is_valet_parking==1) checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_valet_parking" type="radio"
                                           value="0" @if($business->is_valet_parking==0) checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_boarding" type="radio" value="1" @if($business->is_boarding==1)
                                           checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_boarding" type="radio" value="0" @if($business->is_boarding==0)
                                           checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                        ...
                        <div class="form-group  fa-comment @if($business->is_boarding==0) displayNone @endif">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control width60" id="boardingcomments" name="boarding_comments"
                                          rows="3">{{$business->boarding_comments}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_bar_attached" type="radio"
                                           value="1" @if($business->is_bar_attached==1) checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_bar_attached" type="radio"
                                           value="0" @if($business->is_bar_attached==0) checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="label-radio inline">
                                    <input name="is_highway_res" type="radio"
                                           value="1" @if($business->is_highway_res==1) checked @endif>
                                    <span class="custom-radio"></span>
                                    Yes
                                </label>
                                <label class="label-radio inline">
                                    <input name="is_highway_res" type="radio"
                                           value="0" @if($business->is_highway_res==0) checked @endif>
                                    <span class="custom-radio"></span>
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group  fa-comment  @if($business->is_highway_res==0) displayNone @endif">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control width60" id="highwaydetails" name="highway_details"
                                          rows="3">{{$business->highway_details}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="inputforavgdeliverytime" class="col-lg-2 control-label">Average Delivery
                                Time</label>

                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" id="inputforavgdeliverytime"
                ...
                <div style="" id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control width60 input-sm" id="inputforAddress1"
