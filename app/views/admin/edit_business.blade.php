            ...
            'maxTime': '03:00:00'
                    ...
                    <div class="tab-pane fade" id="logo">
                        ...
                        <div class="form-group" style="margin: 20px">
                            <div class="form-group">
                                <label>VAT Tax</label>
                                <input type="text" class="form-control input-sm" data-bind="value:VAT_tax">
                                <p class="validationMessage" data-bind="validationMessage: VAT_tax"></p>
                            </div>
                            <div class="form-group">
                                <label>Service Tax</label>
                                <input type="text" class="form-control input-sm" data-bind="value:service_tax">
                                <p class="validationMessage" data-bind="validationMessage: service_tax"></p>
                            </div>
                            <div class="form-group">
                                <label>ServiceCharge</label>
                                <input type="text" class="form-control input-sm" data-bind="value:service_charge">
                                <p class="validationMessage" data-bind="validationMessage: service_charge"></p>
                            </div>
                        </div>
                    </div>
