...
<aside class="fixed skin-6">
    <div class="sidebar-inner scrollable-sidebar">
        ...
        <!-- /user-block -->
        <!-- /main-menu -->
        @include('admin._partials.business_menu')
    </div>
    <!-- /sidebar-inner -->
</aside>
...
/common/js/jquery.flot.min.js')}}'></script>

<!--
Morris -->
< script
src = '{{asset('
assets / common / js / rapheal.min.js
')}}' ></script>
<script src='{{asset(' assets
/common/js/morris.min.js')}}'></script>

<!--
Colorbox -->
< script
src = '{{asset('
assets / common / js / jquery.colorbox.min.js
')}}' ></script>

<!-- Sparkline -->
<script src='{{asset(' assets
/common/js/jquery.sparkline.min.js')}}'></script>

<!--
Pace -->
< script
src = '{{asset('
assets / common / js / uncompressed / pace.js
')}}' ></script>

<!-- Popup Overlay -->
<script src='{{asset(' assets
/common/js/jquery.popupoverlay.min.js')}}'></script>

<!--
Slimscroll -->
< script
src = '{{asset('
assets / common / js / jquery.slimscroll.min.js
')}}' ></script>

<!-- Modernizr -->
<script src='{{asset(' assets
/common/js/modernizr.min.js')}}'></script>

<!--
Cookie -->
< script
src = '{{asset('
assets / common / js / jquery.cookie.min.js
')}}' ></script>
<!-- Perfect -->
